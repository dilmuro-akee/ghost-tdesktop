...
void SetupExperimental(
	...
	// Ghost Mode toggles (this fork).
	addToggle(Ghost::kNoReadReceipts);
	addToggle(Ghost::kHideOnline);
	addToggle(Ghost::kStealthTyping);
	addToggle(Ghost::kAntiDelete);
	addToggle(Ghost::kDownloadRestricted);
	addToggle(Ghost::kSaveViewOnce);
	addToggle(Ghost::kAutoSaveOneTime);
	addToggle(Ghost::kShowEditOriginal);
	addToggle(Ghost::kVideoPip);
